...
import Producto from "./Botoncombra";
    ...
    <div className="detalle-container">
      <Row xs= {1} md={2} lg={2}>
       ...
       <div className="detalle-info">
        ...
        {admin ? <Link to={"/admin/editarProducto/" + id}> <Button className="btn btn-light w-50" variant="outline-dark" >Editar Producto</Button></Link> : <Button onClick={funcionCarrito} className="btn btn-light w-50" variant="outline-dark">Agregar al carrito</Button> }
        {admin ? <button variant="outline-light" onClick={dispararEliminar} className="btn btn-dark w-50" >Eliminar Producto</button> : <></>}
      </div>
        </Col>
      </Row>
    </div>
